    ...
    public class Water : MonoBehaviour
    {
        ...
        private void CreateWaterObjects(Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera)
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                if (!reflectionCamera)
                {
                    GameObject go = new GameObject("Water Refl Camera id" + GetInstanceID(), typeof(Camera), typeof(Skybox));
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                if (!refractionCamera)
                {
                    GameObject go = new GameObject("Water Refr Camera id" + GetInstanceID(), typeof(Camera), typeof(Skybox));
